      ...
      <div class="span12">
         ...
         <form class="form-horizontal" action="" method="post" >
            <div class="control-group <?php if(form_error('attribute_name') != '') echo 'error'; ?>">
               ...
               <div class="controls">
                  <input type="text" id="attribute_name" name="attribute_name" value="<?php if(isset($attributesInfo) && !empty($attributesInfo)){echo $attributesInfo->attribute_name;} ?>" />
                  <input type="hidden" id="hidden_attribute_name" name="hidden_attribute_name" value="<?php echo $attributesInfo->attribute_name;?>" />

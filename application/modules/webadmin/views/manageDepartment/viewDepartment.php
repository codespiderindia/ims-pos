...
<div class="page-content">
   ...
   <div class="row-fluid">
      <div class="span12">
         ...
         <div class="row-fluid">
            <div class="span12">
               <div class="table-header tableThemeColor"> Results for "Department" </div>
               <table id="myTable" class="table table-stripedss table-bordered table-hover">
                  <thead>
                     <tr>
                        <th class="center">#</th>
                  ...
                  if(isset($department) && !empty($department)){
                     ...
                     <tr>
                        ...
                        <td><?php echo $department->weekly_off;?></td>
                        <td><?php echo get_user_name_by_user_ID($department->user_ID);?></td>
                        <?php if($permission_array[0]['edit']=='1') { ?>
						<td><label>
                           <input id="department_status_switch_<?php echo $department->department_id;?>" name="department_status_switch_<?php echo $department->department_status;?>" class="ace-switch  ace-switch-3" type="checkbox" <?php if($department->department_status==1){echo "checked=checked";} ?> />
                           <span class="lbl"></span> </label>
                           <?php if($department->department_status==1){echo '<span style=" visibility:hidden">on</span>';} ?>
                           <?php if($department->department_status==0){echo '<span style=" visibility:hidden">off</span>';} ?>
                        </td>
                        ...
                        <td>
                           <div class="hidden-phone visible-desktop btn-group">
                              <?php if($permission_array[0]['edit']=='1') { ?>
                              <a href="<?php echo site_url()."webadmin/managedepartment/editDepartment/".$department->department_id;?>" class="tooltip-info" data-rel="tooltip" title="Edit">
                              <button class="btn btn-mini btn-info"> <i class="icon-edit bigger-120"></i> </button>
                              </a>
                              <?php }?>
                              <?php if($permission_array[0]['delete']=='1') { ?>
                              <a id="delBtn_<?php echo $department->department_id;?>" class="delBtn tooltip-info" href="<?php echo site_url()."webadmin/managedepartment/deleteDepartment/".$department->department_id;?>" data-rel="tooltip" title="Delete">
...
<script>
   $(function(){
   		...
   		$( ".ace-switch-3" ).change(function() {
   			...
   			department_id=$(this).attr('id').split('department_status_switch_');
   			var url="<?php echo site_url();?>webadmin/managedepartment/changeStatus";
   			$.ajax({
   			url: url,
   			type:'GET',
   			data:"status="+change_status_to+"&department_id="+department_id[1],

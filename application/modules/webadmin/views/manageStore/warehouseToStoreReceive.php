           ...
           <div class="control-group <?php if(form_error('status') != '') echo 'error'; ?>">
               ...
               <div class="controls">
                  <select name="status" class="status" id="status">
                     <option value="1" <?php if(isset($warehouseToStoreReceiveInfo[0]->status) && ($warehouseToStoreReceiveInfo[0]->status==1)) echo "selected";?>>Complete</option>
					 <option value="2" <?php if(isset($warehouseToStoreReceiveInfo[0]->status) && ($warehouseToStoreReceiveInfo[0]->status==2)) echo "selected";?>>Incomplete</option>
                  </select>
            ...
            <div class="control-group <?php if(form_error('comments') != '') echo 'error'; ?>">
               ...
               <div class="controls">
                  <textarea id="comments" name="comments"><?php if(isset($warehouseToStoreReceiveInfo[0]->comments) && !empty($warehouseToStoreReceiveInfo[0]->comments)) echo $warehouseToStoreReceiveInfo[0]->comments; ?></textarea>

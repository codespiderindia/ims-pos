      ...
      <div class="span12">
         ...
         <div class="row-fluid">
            <div class="span12">
			   ...
			   ?>
               <div class="table-header tableThemeColor">Results for "Vendor To Warehouse Invoice"</div>
                  ...
                  <tbody>
					...
					?>
				  	<tr>
						...
						<td><a href="<?php echo site_url()."webadmin/managewarehouse/viewVendorToWarehouseProduct/".base64_encode($invoice->invoice_id); ?>">View Invoice</a></td>
					</tr>
					<?php $ctr++; 
						  } //end if condition	
						} //end foreach

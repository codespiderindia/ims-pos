   ...
   <div class="row-fluid">
      <div class="span12">
         ...
         <div class="row-fluid">
            ...
            ?>
               <div class="table-header tableThemeColor">Results for "Warehouse To Store Receive"</div>
               ...
               <?php 
                  ...
                  foreach($wareHouseToStoreInvoiceAllRecords as $invoice){
                     ...
                     //if($invoice->warehouse_to==$uinfo['warehouse_id']){
               ?>
               <tr>
                  <td><?php echo $ctr; ?></td>
                  <td><?php 
                  ...
                  <td><a href="<?php echo site_url()."webadmin/managestore/warehouseToStoreReceive/".base64_encode($invoice->invoice_id); ?>">Receive Entry</a></td>
               </tr>
               <?php $ctr++; 
                    }
                    //} //end if condition   

         ...
         <div class="row-fluid">
            <div class="span12">
               <?php
                  ...
                  if(isset($storeAllRecordsByLocation) && !empty($storeAllRecordsByLocation)){
                   ?>
               <div class="table-header tableThemeColor"> Results for "Location Stores" </div>
               <table id="myTable" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                     <?php 
                        ...
                        foreach($storeAllRecordsByLocation as $account){
                         ?>

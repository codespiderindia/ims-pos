   ...
   <div class="row-fluid">
      <div class="span12">
         ...
         <div class="row-fluid">
            <div class="span12">
               <?php
               if(isset($storeToWhInvoiceAllRecords) && !empty($storeToWhInvoiceAllRecords)){
			   ?>
               ...
               <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
				  	<?php 
						...
						foreach($storeToWhInvoiceAllRecords as $invoice){
					...
					?>
				  	<tr>
						...
						?></td>
						<td><?php 
						  $warehouse_name = getWarehouseName($invoice->warehouse_to);
						...
						<td><a href="<?php echo site_url()."webadmin/managestore/viewStoreToWhTransfer/".base64_encode($invoice->invoice_id); ?>">View Invoice</a></td>
					</tr>
					<?php $ctr++; 
						  } //end if condition	
						} //end foreach

   ...
   <div class="row-fluid">
      <div class="span12">
         ...
         <div class="row-fluid">
            <div class="span12">
               <?php
                  if(isset($storeToStoreInvoiceAllRecords) && !empty($storeToStoreInvoiceAllRecords)){
			   ?>
               ...
               <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
				  	<?php 
						...
						foreach($storeToStoreInvoiceAllRecords as $invoice){
							if($uinfo['user_level']<$invoice->user_level || $uinfo['user_level']==1) {
					?>
				  	<tr>
						<td><?php echo $ctr; ?></td>
						<td><?php 
						  $store_name = get_store_details_by_id($invoice->store_from);
						  echo ucfirst($store_name[0]['store_name']);
						?></td>
						<td><?php 
						  $store_name = get_store_details_by_id($invoice->store_to);
						  echo ucfirst($store_name[0]['store_name']);
						?></td>
						<td><?php 
						...
						<td><a href="<?php echo site_url()."webadmin/managestore/viewStoreToStoreTransfer/".base64_encode($invoice->invoice_id); ?>">View Invoice</a></td>

      ...
      <div class="span12">
         ...
         <div class="row-fluid">
            <div class="span12">
			   ...
			   ?>
               <div class="table-header tableThemeColor">Results for "Warehouse To Warehouse Receive"</div>
                  ...
                  <tbody>
					...
					?>
				  	<tr>
						...
						<td><a href="<?php echo site_url()."webadmin/managewarehouse/warehouseToWarehouseReceive/".base64_encode($invoice->invoice_id); ?>">Receive Entry</a></td>
					</tr>
					<?php $ctr++; 
						  }
						  //} //end if condition	

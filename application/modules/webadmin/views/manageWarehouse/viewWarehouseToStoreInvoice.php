   ...
   <div class="row-fluid">
      <div class="span12">
         ...
         <div class="row-fluid">
            <div class="span12">
               <?php
                  if(isset($wareHouseToStoreInvoiceAllRecords) && !empty($wareHouseToStoreInvoiceAllRecords)){
			   ?>
               <div class="table-header tableThemeColor">Results for "Warehouse To Store Invoice"</div>
               <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
				  	<?php 
						...
						foreach($wareHouseToStoreInvoiceAllRecords as $invoice){
							if($uinfo['user_level']<$invoice->user_level || $uinfo['user_level']==1) {
					?>
				  	<tr>
						<td><?php echo $ctr; ?></td>
						<td><?php 
						  $getWarehouseIdByWarehouseName = getWarehouseIdByWarehouseName($invoice->warehouse_id);
						...
						?></td>
						<td><?php 
						  $store_name = get_store_details_by_id($invoice->store_id);
						...
						<td><?php echo $invoice->modified_date; ?></td>
						
						<td><a href="<?php echo site_url()."webadmin/managewarehouse/viewWarehouseToStoreTransfer/".base64_encode($invoice->invoice_id); ?>">View Invoice</a></td>

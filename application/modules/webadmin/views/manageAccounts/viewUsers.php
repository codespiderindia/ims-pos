...
<div class="page-content">
   <div class="page-header position-relative">
      <h1 class="headingThemeColor">Account List</h1>
            ...
            <div class="span12">
             ...
             //  echo '<pre>';print_r($user_accounts);
                  ...
                  if(isset($user_accounts) && !empty($user_accounts)){
                   ?>
               <div class="table-header tableThemeColor"> Results for "Registered Accounts" </div>
               <table id="myTable" class="table table-striped table-bordered table-hover">
                  <thead>
                     <tr>
                        ...
                        <th>HR Approval</th>
                        <th>Action</th>
						      <th>Store User Transfer</th>
						      <th>Warehouse User Transfer</th>
                     </tr>
                  </thead>
                  <tbody>
                     <?php //echo $uinfo['user_level'].'user_level'.'</br>';
                     ...
                     <tr> 
						...
						<td style="color:red;font-size:12px">NOT Assigned <br> <a target="_blank" class="add_user" href="<?php echo site_url()."webadmin/manageaccounts/addUsersForStore/".$account->user_ID;?>">Assign Store</a></td> 
						<?php }else{ ?>
						<td>
                           <?php 
						...
						<td style="color:red;font-size:12px">NOT Assigned <br><a target="_blank" class="add_user" href="<?php echo site_url()."webadmin/manageaccounts/addUsersForWarehouse/".$account->user_ID;?>">Assign Warehouse</a></td>
						<?php }else{?>
						<td>
                           <?php 
                              
                              	echo getWarehouseName($account->warehouse_id);
                              ?>
                        </td>
						<?php }?>
                        <td><?php 
                                $date_created = $account->user_created;
						...
						<td><a href="<?php echo site_url()."webadmin/manageaccounts/editUsersForStore/".$account->user_ID; ?>"><button class="btn btn-minier btn-purple">Transfer</button></a></td>
						<td><a href="<?php echo site_url()."webadmin/manageaccounts/editUsersForWarehouse/".$account->user_ID; ?>"><button class="btn btn-minier btn-purple">Transfer</button></a></td>
                     </tr>
                     <?php }}?>
                     <?php $ctr++; }?>
                  </tbody>

                     ...
                     <tr>
                        ...
                        <td>
                           <div class="hidden-phone visible-desktop btn-group">
							  ...
							  <a id="delBtn_<?php echo $roles->role_code; ?>" href="<?php echo site_url()."webadmin/manageoffer/deleteRoles/".base64_encode($roles->role_code); ?>" class="tooltip-info delBtn" data-rel="tooltip" title="Delete">	

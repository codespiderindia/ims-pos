   ...
   <div class="row-fluid">
    ...
    //if(((date('Y-m-d', strtotime($endDate))) > (date('Y-m-d', strtotime($currentDate)))) || ($endDate == NULL)) {
			...
			<div class="control-group <?php if(form_error('specification') != '') echo 'error'; ?>">
               <label class="control-label" for="specification">HSN Code</label>
               <div class="controls">
                  <textarea id="specification_old" name="specification_old" style="display:none;"> </textarea>
				  <input type="text" id="specification" name="specification" value="<?php echo set_value('specification') ?>" />

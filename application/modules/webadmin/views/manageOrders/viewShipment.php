               ...
               <table id="sample-table-2" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td><a href="<?php echo base_url();?>webadmin/manageorders/viewShipmentDetail/<?php echo $single->shipment_id; ?>/<?php echo $single->order_id; ?>"><?php echo $single->shipment_id;?></a>
                        </td>
                        <td><?php echo $single->address; ?></td>
                        <td><?php echo $single->lr_number; ?></td>
                         <td><?php echo $single->lr_date; ?></td>
						     
						      <td><?php echo $status; ?></td>
                        <td><input class="btn btn-info buttonThemeColor" id="<?php echo $ctr;?>" type="button" name="submit_status" onclick="location.href='<?php echo base_url();?>webadmin/manageorders/shipmentPdfGenerator/<?php echo $single->shipment_id;?>/<?php echo $single->order_id; ?>'" value="Print Invoice"/></td>
                     </tr>
                     <?php $ctr++; } ?>
                  </tbody>
               </table>

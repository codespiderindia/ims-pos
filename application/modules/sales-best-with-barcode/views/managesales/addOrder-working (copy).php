   ...
   <div class="row-fluid">
		<div class="span9" style="width: 79.359%;">
			<!--PAGE CONTENT BEGINS-->
				...
				<div class="widget-body">
					<div class="widget-main ">
						<form name="item_info_frm" id="item_info_frm" method="post" action="<?php echo base_url();?>sales/managesales/addItemToCart" autocomplete="off">
				...
				delay: 150,
		 		...
		 		select: function( event, ui ) 
		 		{
					$( "#item" ).val(ui.item.value);
		 			...
		 			$('#item_info_frm').ajaxSubmit({target: "#div_cart", success: itemScannedSuccess});

		 			//$("#item_info_frm").ajaxSubmit({success: add_order});  

		 			//$(this).val(ui.item.value);
					//$("#item_info_frm").submit();
					return false;
		 		},
...
$('#item').focus();
	...
	$('#item').blur(function()
	{
		$(this).val("Start Typing item's name or scan barcode...");
	});

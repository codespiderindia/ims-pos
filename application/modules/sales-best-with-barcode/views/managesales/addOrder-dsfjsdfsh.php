   ...
   <div class="row-fluid">
		<div class="span9" style="width: 79.359%;">
			<!--PAGE CONTENT BEGINS-->
				...
				<div class="widget-body">
					<div class="widget-main ">
						<form name="add_item_form" id="item_info_frm" method="post" action="<?php echo base_url();?>sales/managesales/addItemToCart" autocomplete="off">

<input type="text" id="item" name="item"  class="add-item-input pull-left keyboardTop" placeholder="Enter item name or scan barcode" data-title="Item Name">
						<table >
				...
				delay: 150,
		 		...
		 		select: function( event, ui ) 
		 		{
					$( "#item" ).val(ui.item.value);
		 			$('#add_item_form').ajaxSubmit({target: "#div_cart", beforeSubmit: salesBeforeSubmit, success: itemScannedSuccess});
...
// Re-usable Functions 
	...
	$('#add_item_form').ajaxForm({target: "#div_cart", beforeSubmit: salesBeforeSubmit, success: itemScannedSuccess});

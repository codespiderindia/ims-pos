   ...
   <div class="row-fluid">
      <div class="span12">
         ...
         <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
            <div class="control-group <?php if(form_error('comp_name') != '') echo 'error'; ?>">
               <label class="control-label" for="comp_name">Company Name</label>
               <div class="controls">
                  <input type="text" id="comp_name" name="comp_name" value="<?php if(isset($compInfo->comp_name)) { echo $compInfo->comp_name; }  ?>" />
                  <span for="f_name" class="help-inline f_name"> <?php echo form_error('comp_name') ?> </span>
               </div>
            </div>
			<div class="control-group <?php if(form_error('comp_address') != '') echo 'error'; ?>">
               <label class="control-label" for="comp_address">Company  Address</label>
               <div class="controls">
                  <input type="text" id="comp_address" name="comp_address" value="<?php echo $compInfo->comp_address; ?>" />
                  <span for="l_name" class="help-inline l_name"> <?php echo form_error('comp_address') ?> </span>
               </div>
            </div>
            ...
            <div class="control-group <?php if(form_error('current_pwd') != '') echo 'error'; ?>">
               <label class="control-label" for="current_pwd">Current Password</label>
               <div class="controls">
                  <input type="text" id="current_pwd" name="current_pwd" value="" />
                  <span for="l_name" class="help-inline current_pwd"> <?php echo form_error('current_pwd') ?> </span>
               </div>
            </div>

            <div class="control-group <?php if(form_error('new_pwd') != '') echo 'error'; ?>">
               <label class="control-label" for="new_pwd">New Password</label>
               <div class="controls">
                  <input type="text" id="new_pwd" name="new_pwd" value="" />
                  <span for="l_name" class="help-inline new_pwd"> <?php echo form_error('new_pwd') ?> </span>
               </div>
            </div>

            <div class="control-group <?php if(form_error('confirm_pwd') != '') echo 'error'; ?>">
               <label class="control-label" for="confirm_pwd">Confirm Password</label>
               <div class="controls">
                  <input type="text" id="confirm_pwd" name="confirm_pwd" value="" />
                  <span for="l_name" class="help-inline l_name"> <?php echo form_error('confirm_pwd') ?> </span>
               </div>
            </div>



            <div class="control-group <?php if(form_error('company_image') != '') echo 'error'; ?>">
            	<label class="control-label" for="company_image">Company Image</label>
            	<div class="controls">
            		<?php 
                     if(isset($compInfo->comp_image) && !empty($compInfo->comp_image)){
                     ?>
                  	<img width="100" height="100" src="<?php echo base_url().'uploads/company_image/thumbs/'.$compInfo->comp_image; ?>">
                  <?php 
                     }  
                     ?>
                  <input type="file" id="company_image" name="company_image" value="<?php if(isset($compInfo->comp_image) && !empty($compInfo->comp_image)){echo $compInfo->comp_image;}?>" />
                  <input type="hidden" id="hdn_company_image" name="hdn_company_image" value="<?php if(isset($compInfo->comp_image) && !empty($compInfo->comp_image)){echo $compInfo->comp_image;}?>" />
                  <span for="name" class="help-inline Image">
                  <?php // echo form_error('product_image') ?>
                  </span>
				</div>		
			</div>

			<!--<div class="control-group <?php if(form_error('comp_username') != '') echo 'error'; ?>">
               <label class="control-label" for="comp_username">Username</label>
               <div class="controls">
                  <input type="text" id="comp_username" name="comp_username" value="<?php echo set_value('comp_username') ?>" />
                  <span for="name" class="help-inline comp_username"> <?php echo form_error('comp_username') ?> </span>
               </div>
            </div>

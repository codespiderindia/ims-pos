         ...
         <div class="row-fluid">
            <div class="span12">
               <?php
                  ...
                  ?>
               <div class="table-header tableThemeColor"> Results for "Registered Companies" </div>
               <table id="myTable" class="table table-stripeds table-bordered table-hover">
                  <thead>
                     <tr>
                        <th class="center">#</th>
                        <th>Company Name</th>
                  ...
                  <tbody>
					 ...
					 ?>
                     <tr><?php //echo crypt(str); ?>
                        <td class="center"><?php echo $ctr;?></td>
                        <td><?php echo $comp->comp_name;?></td>
                        <td><?php echo $comp->comp_username;?></td>
                        <td><?php echo (($comp->ucomppwd != '') ? $comp->ucomppwd : $comp->ccomppwd);?></td>
                        <td><?php echo $comp->comp_address; ?></td>
						
									<td>    
                           <label>
                           <input id="comp_status_switch_<?php echo $comp->comp_id;?>" name="comp_status_switch_<?php echo $comp->comp_id;?>" class="ace-switch ace-switch-3" type="checkbox" <?php if($comp->comp_status==1){echo "checked=checked";} ?> />
                           <span class="lbl"></span>												</label>
                           <?php if($comp->comp_status==1){echo '<span style=" visibility:hidden">on</span>';} ?>
                           <?php if($comp->comp_status==0){echo '<span style=" visibility:hidden">off</span>';} ?>
                        </td>
			
                        <td>
                           <div class="hidden-phone visible-desktop btn-group">
                              <a href="<?php echo site_url()."mainadmin/managecompanies/editCompany/".$comp->comp_id;?>" class="tooltip-info" data-rel="tooltip" title="Edit">
                              <button class="btn btn-mini btn-info"> <i class="icon-edit bigger-120"></i> </button>
                              </a>
             
                              <a id="delBtn_<?php echo $comp->comp_id;?>" class="delBtn tooltip-info" href="<?php echo site_url()."mainadmin/managevendor/deleteVendor/".$comp->comp_id;?>" data-rel="tooltip" title="Delete">
...
<script>
   $(function(){
   		...
   		$( ".ace-switch-3" ).change(function() {
   			...
   			vendor_id=$(this).attr('id').split('comp_status_switch_');
   			var url="<?php echo site_url();?>mainadmin/managecompanies/changeCompanyStatus";
   			$.ajax({
   			url: url,
   			type:'GET',
   			data:"company_status="+change_status_to+"&vendor_id="+vendor_id[1],

      ...
      <div class="span12">
         ...
         <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
            <div class="control-group <?php if(form_error('comp_name') != '') echo 'error'; ?>">
               ...
               <div class="controls">
                  <input type="text" id="comp_name" name="comp_name" value="<?php echo set_value('comp_name') ?>" />
			...
			<div class="control-group <?php if(form_error('comp_address') != '') echo 'error'; ?>">
               ...
               <div class="controls">
                  <input type="text" id="comp_address" name="comp_address" value="<?php echo set_value('comp_address') ?>" />
            ...
            <div class="control-group <?php if(form_error('comp_email') != '') echo 'error'; ?>">
               <label class="control-label" for="comp_email">Email</label>
               <div class="controls">
                  <input type="text" id="comp_email" name="comp_email" value="<?php echo set_value('comp_email') ?>" />
                  <span for="name" class="help-inline comp_email"> <?php echo form_error('comp_email') ?> </span>
               </div>
            </div>
            ...
            <div class="control-group <?php if(form_error('company_image') != '') echo 'error'; ?>">
            	...
            	<div class="controls">
	            <input type="file" id="company_image" name="company_image" value="<?php echo set_value('company_image') ?>" />
	            <span for="name" class="help-inline cpassword"> <?php echo form_error('company_image') ?> </span>
				</div>		
			</div>

		...
		<div class="widget-box">
				...
				<div class="widget-body">
					...
					<div class="widget-main ">
						...
						<input type="text" name="country" id="autocomplete-ajax" style="position: absolute; z-index: 2; background: transparent;"  autocomplete="off" />
...
<script src="<?php echo base_url();?>assets/js/jquery.form.min.js"></script>
	...
	$("#item_info_frm").ajaxForm({success: add_order,clearForm:true});  
});

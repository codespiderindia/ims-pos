   ...
   <body class="login-layout">
                           ...
                           <div id="login-box" class="login-box visible widget-box no-border">
                              <div class="widget-body">
                                 <div class="widget-main">
                                    ...
                                    <div class="space-6">	</div>
                                    <form name="login_form" id="login_form" method="post" action="<?php echo site_url();?>sales/login" />
                                       <fieldset>
                                          <label>
                           ...
                           <div id="forgot-box" class="forgot-box widget-box no-border">
                              <div class="widget-body">
                                 <div class="widget-main">
                                    ...
                                    <div class="space-6"></div>
                                    <form  action="<?php echo site_url();?>sales/login/forgotpassword" name="forgetpassword_frm" id="forgetpassword_frm" enctype="multipart/form-data">
                                       <fieldset>
                                          <div id="showmsg">
                                             <label>
                                             <span class="block input-icon input-icon-right">
      ...
      <script type="text/javascript">
         function show_box(id) {
          ...
          $('#'+id).addClass('visible').css('display','block');
         ...
         // alert('hi');
            if($('#email').val() != '') {
               ...
               $('.help-inline').css('color','red').text('Please Enter EmailId.');
               return false;
            }
           });

...
$( "#btn_download").click(function(page_num) {
	...
	window.location.href =  '<?php echo base_url(); ?>sales/managereports/export_sales_summary?'+url;
...
$('#btn_print').click(function(page_num){
	...
	window.location.href =  '<?php echo base_url(); ?>sales/managereports/print_sales_summary?'+url;
...
function searchFilter(page_num) {
	...
	if(startDate == '') {
		...
		$.ajax({
			...
			url: '<?php echo base_url(); ?>sales/managereports/paginate_sales_summary/'+page_num,

				...
				<div class="widget-body">
					...
					<div class="widget-main ">
						...
						<tr>
							...
							<td><label style="margin-top: -10px;ext-align: left;" >Start Date : &nbsp;</label> </td>
							
							<td><label style="margin-top: -10px;ext-align: left;" >End Date : &nbsp;</label></td>
							
						</tr>
						<tr>
							
							<td>
								<input type="text" id="start_date" name="start_date" value="10/24/1984" />
							</td>
							
							<td>
								<input type="text" id="end_date" name="end_date" value="10/24/1984" />
							</td>
...
function showdate(){
//alert($('#reportrange').data('daterangepicker').startDate);
...
var url='page='+page_num+'&keywords='+keywords+'&sortBy='+sortBy+'&start_date='+startDate+'&end_date='+endDate;
	...
	$.ajax({
		...
		type: 'POST',
		url: '<?php echo base_url(); ?>sales/managereports/ajaxPaginationData/'+page_num,
		data:url,
		beforeSend: function () {
			$('.loading').show();
		},

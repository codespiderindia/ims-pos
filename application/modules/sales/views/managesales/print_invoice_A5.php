	...
	<div class="a-table">
	 <table class="a-main a-main1">
	   ...
	   <tr>
	     <td colspan="4">
		   ...
		   <!-- <p>Madurai</p> -->
		   <p>GSTIN/UIN : <?php echo $sale_detail['store_gst_number'];?></p>
		 </td>
		 <td colspan="4">
	 ...
	 <table class="a-main a-main2">
	   ...
	   <tr>
		 ...
		 <td></td>
		 <td></td>
		 <!--<td class=""><?php echo  $sale_detail['sub_total'];?>.00</td>--> <!-- remove "ttl" class -->
...
<?php
		...
		<!--<tr>
		 ...
		 <td class=""><?php echo $sale_detail['discount_amt'];?>.00</td>
	   </tr>
	   <tr>
		 <td></td>
		 <td>CGST</td>
	   ...
	   <tr class="total">
		 ...
		 <td></td>
		 <td></td>
		 <td><b>Rs. <?php echo  $sale_detail['sub_total'];?></b></td>
	   </tr>
	...
	<!--<table class="a-main a-main2">
	 ...
	 <div class="mn-text mn-text1">
	   ...
	   <p><b><?php echo ucwords(@getIndianCurrency($sale_detail['sub_total']));?></b> Only</p>
	 </div>
	 ...
	 <tr>
	 	...
	 	<td colspan="2"><?php echo  $sale_detail['sub_total'];?></td>
	 	<td></td>

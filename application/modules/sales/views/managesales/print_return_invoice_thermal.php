...
<div class="roll-container">
  <div class="roll-top">
	  ...
	  <div class="roll-hd">
		<div class="rl-left">
		  <p>Invoice No.: <?php echo $retInvoiceBarcode;?></p>
		  <?php
	     	if(isset($ret_customer) && !empty($ret_customer)){
	     		?>
					<p>To: <?php echo $ret_customer['fname']." ".$ret_customer['lname'];?></p>
	     		<?php
	     	}else{
	     		?>
	     		<p>To: Nil</p>
  ...
  <div class="table table1">
	  ...
	  <tr>
		...
		<td></td>
		<td></td>
		<td><?php echo  $ret_detail['sub_total'];?></td>
	  </tr>
	  ...
	  <tr>
		...
		<td></td>
		<td></td>
		<td><?php echo $ret_detail['discount_amt']; ?></td>
	  </tr>
...
<?php } ?>
  ...
  <div class="rl-tax">
  	<b><p>Offer Detail</p></b>
  	<div class="table table2">
  		<table>
  			<tr style="">
	 		<td><b>Offer Name</b></td>
	 		<td><b>Discount/Free Product</b></td>
	 		<td><b>Amount</b></td>
	 	</tr>
	 	<?php if(isset($ret_items) && !empty($ret_items)){
	 		$ctr=1;
  ...
  <div class="table table2">
    <table>
	 	...
	 	<tr>
    		<td>SGST</td>
    		<td><?php echo $ret_items_cp[0]['sgst_per'].'%'; ?></td>
    		<td><?php echo $ret_items_cp[0]['sgst_amt']; ?></td>
    	</tr>

    	<tr>
    		<td>CGST</td>
    		<td><?php echo $ret_items_cp[0]['cgst_per'].'%'; ?></td>
    		<td><?php echo $ret_items_cp[0]['cgst_amt']; ?></td>
    	</tr>

    	<tr>
    		<td>IGST</td>
    		<td><?php echo $ret_items_cp[0]['igst_per'].'%'; ?></td>
    		<td><?php echo $ret_items_cp[0]['igst_amt']; ?></td>
    	</tr>

    	<tr>
		    <td><b>Total Tax Value</b></td>
			<td></td>
			<td><?php echo number_format(($ret_items_cp[0]['sgst_amt']+$ret_items_cp[0]['cgst_amt']+$ret_items_cp[0]['igst_amt']),2);?></td>
	    </tr>
  ...
  <div class="btm-roll">
	...
	<div class="roll-hd">
		<div class="rl-left">
		  <p>GSTIN: <?php echo $ret_detail['store_gst_number'];?></p>
		</div>
		<div class="rl-right">
		  <p>E. % O.E.</p>
		</div>

<?php
  ...
  $code  = base64_decode($_GET['code']); // barcode, of course ;)
  $type  = 'code39';
...
/*  $angle = 90;
  ...
  */
  ...
  //imagestring($im, 20, 0, 10, 20, $black, $font, 'Testing....');
  //imagestring($im, 20, 350, 70, $code, $black);

   $white = ImageColorAllocate($im,0xFF,0xFF,0xFF);
 $black = ImageColorAllocate($im,0x00,0x00,0x00);
 //ImageFilledRectangle($im,50,50,150,150,$black);
 ImageString($im,5,360,160,$code,$black);
